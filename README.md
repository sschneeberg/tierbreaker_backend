...
| PUT    | /bracket/<bracket_key>/bulkvote | Bracket key in url parameters, 'option' and 'count' in request body                               | Message                            | Add multiple votes to specific option for specific bracket   |
